...
/**
 * We wish it weren't the case, but Backup and Migrate module is
 * unable to export its settings through Features or Strongarm.
 * So using our super-hacker skills we found this issue with
 * some clues on how to do it:
 * http://drupal.org/node/373786#comment-1327898
 *
 * Obviously this hack to settings.php will change once that module
 * can export. This code will be run on *every page load.* Sob.
 */

$conf['backup_migrate_destinations_defaults'][] = array (
  'destination_id' => 'default-2b61ea81329586ba4752b3587adc38df',
  'name' => 'Daily Backup',
  'type' => 'file',
  'location' => 'private://backup_migrate/daily',
  'settings' => 
  array (
    'chmod' => '',
    'chgrp' => '',
...
$conf['backup_migrate_destinations_defaults'][] = array (
  'destination_id' => 'default-eaa17cddd75f18dbfb803fe8ea935587',
  'name' => 'Weekly Backups',
  'type' => 'file',
  'location' => 'private://backup_migrate/weekly',
  'settings' => 
  array (
    'chmod' => '',
    'chgrp' => '',
...
$conf['backup_migrate_profiles_defaults'][] = array(
  'profile_id' => 'default-06e588bf550fbc026c19c60aec1a8c9f',
  'name' => 'Daily Backup',
  'filename' => '[site:name]',
  'append_timestamp' => '1',
  ...
  array (
    ...
    'utils_site_offline_message' => 'localhost is currently under maintenance. We should be back shortly. Thank you for your patience.',
    'utils_description' => 'This is a daily backup of a Drupal site. It does not lock tables or take the site offline.',
    'destinations' => 
    array (
      'db' => 
      array (
...
$conf['backup_migrate_profiles_defaults'][] = array (
  'profile_id' => 'default-9cfa20165db1ea0b46560cbc0ad41341',
  'name' => 'Weekly Backup',
  'filename' => '[site:name]',
  'append_timestamp' => '1',
  'timestamp_format' => 'Y-m-d\\TH-i-s',
  ...
  array (
    'compression' => 'gzip',
    'notify_success_enable' => 0,
    'notify_success_email' => 'paul@mile23.com',
    'notify_failure_enable' => 0,
    'notify_failure_email' => 'paul@mile23.com',
    'utils_site_offline' => 1,
    'utils_site_offline_message' => 'localhost is currently under maintenance. We should be back shortly. Thank you for your patience.',
    'utils_description' => 'This is a weekly backup of a Drupal site.',
    'destinations' => 
    array (
      'db' => 
      array (
...
$conf['backup_migrate_schedules_defaults'][] = array(
  'schedule_id' => 'default-db44d296e2b6fc6b4768a1f1bf2b432f',
  'name' => 'Weekly Backups',
  'source_id' => 'db',
  'destination_id' => 'default-eaa17cddd75f18dbfb803fe8ea935587',
  'profile_id' => 'default-9cfa20165db1ea0b46560cbc0ad41341',
...
$conf['backup_migrate_schedules_defaults'][] = array(
  'schedule_id' => 'default-df96e0b8ffc2349ea5574a0df238bdb4',
  'name' => 'Daily Backups',
  'source_id' => 'db',
  'destination_id' => 'default-2b61ea81329586ba4752b3587adc38df',
  'profile_id' => 'default-06e588bf550fbc026c19c60aec1a8c9f',
